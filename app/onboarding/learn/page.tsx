...
export default function LearnPage() {
  ...
  // Sprint 2.1: "Different people" look without wiring avatars/images yet
  ...
  // Stub distribution widths (later: real vote data)
